...
/*  The maccro POK_CONFIG_NB_PARTITIONS_NLOCKOBJECTS indicates the amount of  */
/*  lockobjects in each partition  */

#define POK_CONFIG_PARTITIONS_SIZE {1}
...
#define POK_CONFIG_SCHEDULING_MAJOR_FRAME 500
